...
public class SingleMatchExample
{
    public static void main(String[] args)
    {
        ...
        BattleshipsPlayer player2 = new Slayer();
        ...
        System.out.println("ProbDensity (Points for the game): " + res.majorPointsB);
        System.out.println("player1 minor (Rounds won): " + res.minorPointsA);
        System.out.println("ProbDensity (Rounds won): " + res.minorPointsB);
    }
